                        ...
                        <div class="section-box" style="border-right: none;">
                            ...
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <select id="selGiaCombo" class="form-select-custom">
                                        <option value="">-- Chọn giá combo --</option>
                                        @php
                                        $giaList = $combos->pluck('gia_co_ban')->unique()->sort();
                                        @endphp
                                ...
                                <div id="combo-picker-container" class="d-none"
                                    style="max-height: 250px; overflow-y: auto; border: 1px solid #e2e8f0; border-radius: 6px; padding: 10px;">
                                    @forelse ($combos as $c)
                                    <div class="combo-item"
                                        data-combo-price="{{ $c->gia_co_ban }}">
                                        <div class="combo-name">
                                            {{ $c->ten_combo }}
                                            <span class="combo-price">({{ number_format($c->gia_co_ban) }}đ | {{ $c->thoi_luong_phut }}p)</span>
                                        </div>
