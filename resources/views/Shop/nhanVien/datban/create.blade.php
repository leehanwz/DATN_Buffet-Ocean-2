                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6">
                        <div class="section-box">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label-custom">Người lớn</label>
                                    <input type="number" name="nguoi_lon" class="form-control-custom" min="1" value="{{ old('nguoi_lon', 1) }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label-custom">Trẻ em</label>
                                    <input type="number" name="tre_em" class="form-control-custom" min="0" value="{{ old('tre_em', 0) }}">
                                </div>
                                <div class="col-6 mb-3">
...
<script>
    ...
    function timBanTrong() {
        ...
        var inpNguoiLon = document.querySelector('input[name="nguoi_lon"]');
        var inpTreEm = document.querySelector('input[name="tre_em"]');
        var timeVal = inpTime.value;
        var soKhachVal = parseInt(inpNguoiLon.value || 0) + parseInt(inpTreEm.value || 0);
        var selBan = document.getElementById('selBanAn');
        if (!inpTime || !inpNguoiLon || !inpTreEm) return;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // 2. Event Listeners
        if (inpNguoiLon) inpNguoiLon.addEventListener('change', timBanTrong);
        if (inpTreEm) inpTreEm.addEventListener('change', timBanTrong);
        if (inpNguoiLon) inpNguoiLon.addEventListener('keyup', timBanTrong);
        if (inpTreEm) inpTreEm.addEventListener('keyup', timBanTrong); // Thêm keyup để tìm nhanh hơn
