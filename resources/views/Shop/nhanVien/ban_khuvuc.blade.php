@extends('layouts.shop.layout-shop')
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <form method="get" action="{{ route('nv.ban-an.index') }}">
                        @if(request('search'))
                        ...
                        <div class="col-6 col-sm-4 col-md-3 mb-3">
                            <div class="table-card p-3 rounded shadow-sm text-center">
                                ...
                                @if($datBan && $datBan->trang_thai === 'da_xac_nhan')
                                    <form method="POST" action="{{ route('nv.ban-an.check-in-dattruoc') }}">
                                        @csrf
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    {{-- Form tìm kiếm --}}
                    <form method="get" action="{{ route('nv.ban-an.index') }}" class="d-flex">
...
<style>
.table-card { border:1px solid #eee; padding:10px; text-align:center; }
.table-number { font-size:22px; font-weight:600; }
.badge-status { padding:6px 8px; border-radius:6px; display:inline-block; margin-bottom:5px; }
.badge-trong { background:#d4edda; color:#155724; }
.badge-giu { background:#fff3cd; color:#856404; }
.badge-dadat { background:#ffe5d0; color:#7a4200; }
.badge-co-khach { background:#f8d7da; color:#721c24; }
.badge-khong-su-dung { background:#e2e3e5; color:#6c757d; }
.badge-success { background:#28a745; color:#fff; border-radius:5px; }
</style>
