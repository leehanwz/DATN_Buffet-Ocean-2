...
@section('content')
    ...
    <style>
        .star-rating {
            direction: rtl; /* Đảo ngược chiều để xử lý hover từ phải qua trái */
            display: inline-flex;
        ...
        .star-rating label {
            color: #ccc; /* Màu xám khi chưa chọn */
            cursor: pointer;
            transition: all 0.2s;
            padding: 0 5px;
        }
            ...
            <div class="row g-4">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <p>
                                ...
                                <a href="https://www.facebook.com/oceanbuffet.vn" target="_blank" class="text-dark">facebook.com/oceanbuffet.vn</a>
                            </p>
                        </div>
                        <div class="col-md-4">
                            ...
                            <p>
                                ...
                                <a href="https://www.instagram.com/ocean.buffet.vn" target="_blank" class="text-dark">instagram.com/ocean.buffet.vn</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.0968141837515!2d105.85017607593256!3d21.028811887779344!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab9bd9861ca1%3A0xe7887f7b72ca17a9!2sHanoi%2C%20Hoan%20Kiem%2C%20Hanoi!5e0!3m2!1sen!2s!4v1701918345645!5m2!1sen!2s"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="ten_khach" id="ten_khach" placeholder="Họ tên" required value="{{ old('ten_khach') }}">
                                        <label for="ten_khach">Họ tên *</label>
                                    </div>
                                    @error('ten_khach')<div class="text-danger small">{{ $message }}</div>@enderror
                                </div>
                
                                {{-- Số điện thoại --}}
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="sdt" id="sdt" placeholder="Số điện thoại" required value="{{ old('sdt') }}">
                                        <label for="sdt">Số điện thoại *</label>
                                    </div>
                                    @error('sdt')<div class="text-danger small">{{ $message }}</div>@enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="nghe_nghiep" id="nghe_nghiep" placeholder="Nghề nghiệp" value="{{ old('nghe_nghiep') }}">
                                        <label for="nghe_nghiep">Nghề nghiệp</label>
                                    </div>
                                    @error('nghe_nghiep')<div class="text-danger small">{{ $message }}</div>@enderror
                                </div>
...
<div class="col-12">
    <div class="form-group border rounded p-3 bg-light">
        ...
        <div class="d-flex align-items-center mt-2">
            ...
            <div class="star-rating">
                {{-- Sao 5 --}}
                <input type="radio" id="star5" name="so_sao" value="5" checked />
    ...
    @error('so_sao')<div class="text-danger small">{{ $message }}</div>@enderror
</div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        ratingLabels.forEach(label => {
            label.addEventListener('mouseenter', function() {
                const hoverValue = this.getAttribute('for').replace('star', ''); // Lấy số 1,2,3,4,5 từ ID
                ratingText.textContent = messages[hoverValue];
                ratingText.classList.remove('text-primary');
                ratingText.classList.add('text-muted'); // Đổi màu xám khi đang hover để phân biệt
            });
            ...
            label.addEventListener('mouseleave', function() {
                ...
                if(checkedInput) {
                    ...
                    ratingText.classList.add('text-primary');
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Nội dung" name="noi_dung" id="noi_dung" style="height: 150px" required>{{ old('noi_dung') }}</textarea>
                                        <label for="noi_dung">Nội dung đánh giá *</label>
                                    </div>
                                    @error('noi_dung')<div class="text-danger small">{{ $message }}</div>@enderror
                                </div>
