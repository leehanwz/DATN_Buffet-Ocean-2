...
{{-- =========================================================== --}}
{{-- 0. KHU VỰC LOAD THƯ VIỆN (QUAN TRỌNG: KHÔNG ĐƯỢC XÓA) --}}
{{-- =========================================================== --}}
{{-- Flatpickr (Lịch) CSS --}}
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
{{-- Flatpickr Theme Tối (để hợp với giao diện) --}}
...
<style>
    ...
    #dropdownTimeBtn {
        ...
        /* Căn chỉnh cho khớp với ô input ngày */
    }
    ...
    <div class="container my-5 py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-start">
                ...
                <p class="text-white animated slideInLeft mb-4 pb-2">Trải nghiệm ẩm thực tuyệt vời với các gói Combo đa
                    dạng từ 99k đến 499k.</p>
                <a href="#booking-section" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Đặt Bàn
                    Ngay</a>
            </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-4">Nhà hàng Buffet Ocean tự hào mang đến trải nghiệm ẩm thực đẳng cấp với thực đơn phong
                    phú.</p>
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form action="{{ route('booking.store') }}" method="POST" id="bookingForm">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating"><input type="text" class="form-control" id="ten_khach"
                                    name="ten_khach" placeholder="Họ và Tên" value="{{ old('ten_khach') }}"
                                    required><label for="ten_khach">Họ và Tên</label></div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating"><input type="email" class="form-control" id="email_khach"
                                    name="email_khach" placeholder="Email" value="{{ old('email_khach') }}"><label
                                    for="email_khach">Email</label></div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating"><input type="text" class="form-control" id="sdt_khach"
                                    name="sdt_khach" placeholder="Số Điện Thoại" value="{{ old('sdt_khach') }}"
                                    required><label for="sdt_khach">Số Điện Thoại</label></div>
                        </div>
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="form-floating">
                                        {{-- Ô Chọn Ngày --}}
                                        <input type="text" class="form-control bg-white" id="booking_date"
                                            placeholder="Ngày" required style="cursor: pointer;">
                                ...
                                <div class="col-6">
                                    <div class="form-floating">
                                        ...
                                        <div class="dropdown h-100">
                                            <button class="form-control bg-white text-start h-100" type="button"
                                                id="dropdownTimeBtn" data-bs-toggle="dropdown" aria-expanded="false">
                                                Chọn giờ
                                            </button>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating"><input type="number" class="form-control" id="nguoi_lon"
                                    name="nguoi_lon" placeholder="Người lớn" value="{{ old('nguoi_lon', 1) }}" min="1"
                                    required><label for="nguoi_lon">Số Người Lớn</label></div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating"><input type="number" class="form-control" id="tre_em"
                                    name="tre_em" placeholder="Trẻ em" value="{{ old('tre_em', 0) }}" min="0"><label
                                    for="tre_em">Số Trẻ Em</label></div>
                        </div>

                        <div class="col-12">
                            <div class="form-floating"><textarea class="form-control" placeholder="Ghi chú" id="ghi_chu"
                                    name="ghi_chu" style="height: 100px">{{ old('ghi_chu') }}</textarea><label
                                    for="ghi_chu">Ghi chú</label></div>
                        </div>
                        <div class="col-12"><button class="btn btn-primary w-100 py-3" type="submit">Xác Nhận Đặt
                                Bàn</button></div>
                    </div>
                </form>
            </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        ...
                        <div class="small text-warning mt-1">
                            @for($i = 1; $i <= 5; $i++) @if($i <=$item->so_sao) <i class="fas fa-star"></i>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Kiểm tra xem Bootstrap có tồn tại không trước khi khởi tạo
        let cartModal, detailModal;
        try {
            cartModal = new bootstrap.Modal(cartModalElement);
            detailModal = new bootstrap.Modal(document.getElementById('productDetailModal'));
        } catch (e) {
            console.error("Lỗi: Chưa load Bootstrap 5 JS! Hãy kiểm tra file layouts/master.blade.php", e);
        }
        ...
        if(floatingCartIcon && cartModal) floatingCartIcon.addEventListener('click', () => { cartModal.show(); });
        ...
        if (typeof flatpickr !== 'undefined') {
            ...
            console.error("Lỗi: Thư viện Flatpickr chưa load được!");
        }
