        ...
        <table class="table table-hover table-bordered align-middle text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <strong>{{ $hd->datBan->banAn->id ?? 'N/A' }}</strong><br>
                        <small>Khách: {{ $hd->datBan->ten_khach ?? 'N/A' }}</small>
                    </td>
                    {{-- Tổng tiền món (tính động) --}}
                    <td class="text-end">{{ number_format($hd->tinhTongTien()) }}₫</td>
                    {{-- Tiền giảm --}}
                    ...
                    <td>
                        ...
                        <span class="badge bg-primary" data-bs-toggle="tooltip" title="Thanh toán tiền mặt">Tiền
                            mặt</span>
                        @else
                        <span class="badge bg-secondary" data-bs-toggle="tooltip"
                            title="Thanh toán QR / Chuyển khoản">Chuyển khoản</span>
                        @endif
                    </td>
                    {{-- Ngày tạo --}}
