                    ...
                    <div class="tile-body">
                        ...
                        <form class="row" method="POST" action="{{ route('ban-an.update', $banAn->id) }}">
                             ...
                             <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="khu_vuc_id" required>
                                    ...
                                    @foreach ($khuVucs as $kv)
                                        <option value="{{ $kv->id }}" {{ old('khu_vuc_id', $banAn->khu_vuc_id) == $kv->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="so_ban" value="{{ old('so_ban', $banAn->so_ban) }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">Số Ghế (*)</label>
                                <input class="form-control" type="number" name="so_ghe" min="1" value="{{ old('so_ghe', $banAn->so_ghe) }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="trang_thai" required>
                                    ...
                                    <option value="khong_su_dung" {{ old('trang_thai', $banAn->trang_thai) == 'khong_su_dung' ? 'selected' : '' }}>Không sử dụng</option>
                                </select>
                            </div>
