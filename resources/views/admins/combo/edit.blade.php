        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <form class="row" action="{{ route('admin.combo-buffet.update', $combo->id) }}" 
                            ...
                            <div class="d-block mt-2">
                                @foreach (['nguoi_lon' => 'Người lớn', 'tre_em' => 'Trẻ em', 'vip' => 'VIP', 'khuyen_mai' => 'Khuyến mãi'] as $value => $label)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="loai_combo" id="loai_{{ $value }}"
                                            value="{{ $value }}" {{ old('loai_combo', $combo->loai_combo) == $value ? 'checked' : '' }}>
                        ...
                        <div class="form-group col-md-12 mt-3">
                            ...
                            <input type="file" class="form-control" name="anh" accept="image/*" onchange="previewFile(event)">
