                    ...
                    <div class="tile-body">
                        ...
                        <form class="row" method="POST" action="{{ route('admin.khu-vuc.update', $khuVuc->id) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="ten_khu_vuc" value="{{ old('ten_khu_vuc', $khuVuc->ten_khu_vuc) }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">Số Tầng (*)</label>
                                <input class="form-control" type="number" name="tang" min="1" value="{{ old('tang', $khuVuc->tang) }}" required>
                            </div>
