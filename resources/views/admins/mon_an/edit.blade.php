...
<div class="app-content" style="padding-top:18px; min-height: calc(100vh - 120px);">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 p-3 rounded shadow-sm"
        ...
        <a href="{{ route('admin.san-pham.index') }}" class="btn btn-light fw-semibold shadow-sm">
            ...
            <form action="{{ route('admin.san-pham.update', $san_pham->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control custom-input" name="gia"
                                value="{{ old('gia', $san_pham->gia) }}" min="0" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold">Mô tả</label>
                            <textarea class="form-control custom-input" name="mo_ta"
                                rows="3">{{ old('mo_ta', $san_pham->mo_ta) }}</textarea>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold">Thời gian chế biến (phút) <span
                        ...
                        <div class="mb-3">
                            ...
                            <select name="trang_thai" class="form-select custom-input" required>
                                <option value="con"
                                    {{ old('trang_thai', $san_pham->trang_thai) == 'con' ? 'selected' : '' }}>Còn món
                                </option>
                                <option value="het"
                                    {{ old('trang_thai', $san_pham->trang_thai) == 'het' ? 'selected' : '' }}>Hết món
                                </option>
                                <option value="an"
                                    {{ old('trang_thai', $san_pham->trang_thai) == 'an' ? 'selected' : '' }}>Ẩn khỏi menu
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" name="hinh_anh" class="form-control custom-input" accept="image/*"
                            onchange="previewImage(event)">
                        <div class="mt-3 text-center">
                            <div class="border rounded-3 bg-white p-2 shadow-sm d-inline-block">
                                @if($san_pham->hinh_anh)
                                <img id="preview" src="{{ asset($san_pham->hinh_anh) }}" class="img-fluid rounded-3"
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('admin.san-pham.index') }}" class="btn btn-outline-secondary px-4 shadow-sm">
